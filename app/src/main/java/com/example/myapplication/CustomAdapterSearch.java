...
public class CustomAdapterSearch extends RecyclerView.Adapter<CustomAdapterSearch.MyViewHolder> implements Filterable {
    ...
    public CustomAdapterSearch(Context context, Cursor cursor, String username) {
        mContext = context;
        mCursor = cursor;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CustomAdapterSearch.MyViewHolder myViewHolder = new CustomAdapterSearch.MyViewHolder(view);
        return myViewHolder;
    }
