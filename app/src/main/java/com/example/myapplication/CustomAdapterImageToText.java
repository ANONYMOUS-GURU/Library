...
public class CustomAdapterImageToText extends RecyclerView.Adapter<CustomAdapterImageToText.MyViewHolder> {
    ...
    public CustomAdapterImageToText(Context context, String username, ArrayList<myPair> data) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CustomAdapterImageToText.MyViewHolder myViewHolder = new CustomAdapterImageToText.MyViewHolder(view);
        return myViewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        final int bookCode = Integer.parseInt(mp.getName());
        Cursor mCursor = mDatabase.rawQuery("Select * from " + DatabaseHelper.TABLE2 + " where book_code=?", new String[]{String.valueOf(bookCode)});
        mCursor.moveToFirst();
    ...
    public boolean remove_from_imgToText(int position) {
        ...
        mystorage.imageToTextOrder = listData;
        return true;
    }
